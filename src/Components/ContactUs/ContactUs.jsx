    ...
    <div className="container px-6 py-12 mx-auto">
        ...
        <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3 sm:grid-cols-2 ">
            <div className="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
                ...
                <p className="mt-2 text-sm font-semibold text-blue-500 dark:text-blue-400">Fair@electronic.com</p>
            </div>
            ...
            <div className="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
                ...
                <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">Level-4, 34, Awal Centre, Banani, Dhaka</p>
            </div>
            ...
            <div className="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
                ...
                <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">+88 01996928199</p>
            </div>
        </div>
    </div>
</section>
